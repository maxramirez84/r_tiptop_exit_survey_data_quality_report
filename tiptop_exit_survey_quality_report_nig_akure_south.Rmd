...
api.token.exit.survey <- kAPITokenNIGES
# TIPTOP Cost-Effectiveness Health System DRC
api.token.health.systems <- kAPITokenNIGHS 
...
# Partner information
partner.name <- "University of Calabar"
partner.url  <- "https://www.unical.edu.ng/"

# Study area description
country           <- "Nigeria"
study.area.id     <- 2
study.area.label  <- "Akure South"
study.area.column <- "akure_south"
sample.size       <- 142
hf.to.be.surveyed <- 14
